...
FINAL_HELM_VALUES_FILE_PATH = "/tmp/airlift/helm/final_values.yaml"
FINAL_CONFIG_VALUES_FILE_PATH = "/tmp/airlift/final_config.yaml"
FINAL_CLUSTER_CONFIG_FILE_PATH = "/tmp/airlift/kind/final_cluster.yaml"
...
FINAL_DOCKERFILE_PATH = "/tmp/airlift/docker/final/Dockerfile"
